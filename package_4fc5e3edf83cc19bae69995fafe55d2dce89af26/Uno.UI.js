...
(function (Uno) {
    ...
    (function (UI) {
        class WindowManager {
            ...
            setSinglePropertyNative(pParams) {
            ...
            */
            arrangeElementNative(pParams) {
                ...
                this.arrangeElementNativeFast(params.HtmlId, params.Top, params.Left, params.Width, params.Height, params.Clip, params.ClipTop, params.ClipLeft, params.ClipBottom, params.ClipRight);
                return true;
            }
            ...
            */
            ...
            setPointerEventsNativeFast(htmlId, enabled) {
                ...
                static initialize() {
                    ...
                    if (!Geolocator.interopInitialized) {
                        ...
                        if (exports !== undefined) {
                            ...
                            Geolocator.dispatchAccessRequest = Module.mono_bind_static_method("[Uno] Uno.Devices.Geolocation.Geolocator:DispatchAccessRequest");
                            Geolocator.dispatchError = Module.mono_bind_static_method("[Uno] Uno.Devices.Geolocation.Geolocator:DispatchError");
                            Geolocator.dispatchGeoposition = Module.mono_bind_static_method("[Uno] Uno.Devices.Geolocation.Geolocator:DispatchGeoposition");
                        }
                ...
                static initialize() {
                    ...
                    if (window.DeviceMotionEvent) {
                        ...
                        if (exports !== undefined) {
                            ...
                            this.dispatchReading = Module.mono_bind_static_method("[Uno] Uno.Devices.Sensors.Accelerometer:DispatchReading");
                        }
                        return true;
                    }
                    return false;
                ...
                static observeSystemTheme() {
                    if (!SystemThemeHelper.dispatchThemeChange) {
                        if (globalThis.DotnetExports !== undefined) {
                            ...
                            SystemThemeHelper.dispatchThemeChange = Module.mono_bind_static_method("[Uno] Uno.Helpers.Theming.SystemThemeHelper:DispatchSystemThemeChange");
                        }
                    }
                    if (window.matchMedia) {
    ...
    (function (UI) {
        ...
        (function (Core) {
            class SystemNavigationManager {
                constructor() {
                    var that = this;
                    var dispatchBackRequest = globalThis.DotnetExports !== undefined ?
                        globalThis.DotnetExports.Uno.Windows.UI.Core.SystemNavigationManager.DispatchBackRequest :
                        Module.mono_bind_static_method("[Uno] Windows.UI.Core.SystemNavigationManager:DispatchBackRequest");
    ...
    (function (UI) {
        ...
        (function (Xaml) {
            ...
            class UIElement_Pointers {
                static ensurePointersInit() {
                    if (!Xaml.UIElement._dispatchPointerEventMethod) {
                        if (globalThis.DotnetExports !== undefined) {
                            Xaml.UIElement._dispatchPointerEventMethod = globalThis.DotnetExports.UnoUI.Microsoft.UI.Xaml.UIElement.OnNativePointerEvent;
                        }
                        else {
                ...
                static onRootPointerOverDispatching(evt) {
                    ...
                    for (let elt of document.elementsFromPoint(evt.clientX, evt.clientY)) {
                        if (!elt.contains(target) // The elt is under the target (not a parent!)
                            ...
                            try {
                                Xaml.UIElement._isManualyDispatchingOut = true;
                                elt.dispatchEvent(new PointerEvent("pointerout", evt));
                            }
                            finally {
                                Xaml.UIElement._isManualyDispatchingOut = false;
                            }
                        }
                        prevElt = elt;
                    }
                ...
                static onPointerOutReceived(evt) {
                    if (Xaml.UIElement._isManualyDispatchingOut) {
                    ...
                    while (elt && elt != element) {
                        if (elt.style.pointerEvents != "none") {
                            ...
                            if ((evt.clientY > bounds.top && (Math.abs(targetBounds.top - bounds.top) > 1))
            ...
            UIElement_Pointers._isManualyDispatchingOut = false;
            ...
            (function (Media) {
                ...
                (function (Animation) {
                    class RenderingLoopAnimator {
                        ...
                        static setStartFrameDelay(jsHandle, delay) {
                        ...
                        static setAnimationFramesInterval(jsHandle) {
                        ...
                        static enableFrameReporting(jsHandle) {
                        ...
                        static disableFrameReporting(jsHandle) {
...
/* TSBindingsGenerator Generated code -- this code is regenerated on each build */
class WindowManagerSetSinglePropertyParams {
    static unmarshal(pData) {
        const ret = new WindowManagerSetSinglePropertyParams();
        {
            ret.HtmlId = Number(Module.getValue(pData + 0, "*"));
        }
        {
...
/* TSBindingsGenerator Generated code -- this code is regenerated on each build */
class WindowManagerSetStyleStringParams {
    static unmarshal(pData) {
        const ret = new WindowManagerSetStyleStringParams();
        {
            ret.HtmlId = Number(Module.getValue(pData + 0, "*"));
        }
        {
